 ...
 */
export interface TextAnalyticsVerbFirst {
    request: Request;
    requestUnchecked: RequestUnchecked;
}
export declare function createTextAnalyticsVerbFirst(credentials: TokenCredential | KeyCredential, Endpoint: string, options?: PipelineOptions): TextAnalyticsVerbFirst;
export {};
//# sourceMappingURL=textAnalyticsVerbFirst.d.ts.map